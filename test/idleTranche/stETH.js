...
const Strategy = artifacts.require("IdleTrancheStrategyWSTETH_Mainnet");

//This test was developed at blockNumber 15356073

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("IdleTrances: stETH", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x23237b849D0E6f392573EE6aE9e3B1256F058143";
  let weth = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
  let wsteth = "0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0";
  let idle = "0x875773784Af8135eA0ef43b5a374AaD105c5D39e";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0");
  ...
  before(async function () {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      liquidation: [{ uniV3: [ldo, weth] }, { uniV3: [weth, wsteth] }, { sushi: [idle, weth] }],
    });
