...
const Strategy = artifacts.require("ConvexStrategyCVXMainnet");

//This test was developed at blockNumber 12697500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex CVX", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xdD5Bc57BF90e6C6B341120e5b38fb6EdA8e6481d";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x4e3FBD56CD56c3e72c1403e103b45Db9da5B9D2B");
  ...
  before(async function() {
    ...
    feeForwarder = await IFeeForwarder.at(await controller.feeRewardForwarder());
