...
const Strategy = artifacts.require("ConvexStrategyLinkMainnet");

//This test was developed at blockNumber 12555215

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex LINK", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x6A4c4695428d1BB3FAC49614dFCF390BC78FacFE";
  let booster;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xcee60cFa923170e4f8204AE08B4fA6A3F5656F3a");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x24C562E24A4B5D905f16F2391E07213efCFd216E",
