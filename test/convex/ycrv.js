...
const Strategy = artifacts.require("ConvexStrategyYCRVMainnet");

//This test was developed at blockNumber 12555215

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex YCRV", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x77D3C47876e45123C2837Ba68720378Af00a2C0A";
  let booster;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x0FE4283e0216F94f5f9750a7a11AC54D3c9C38F3",
