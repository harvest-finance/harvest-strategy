...
const Strategy = artifacts.require("ConvexStrategyBUSDMainnet");

//This test was developed at blockNumber 12555215

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex BUSD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xbaB89CBE597876364B3bC270b1793C0e2E2aA995";
  let booster;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x3B3Ac5386837Dc563660FB6a0937DFAa5924333B");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x4b1cBD6F6D8676AcE5E412C78B7a59b4A1bbb68a",
