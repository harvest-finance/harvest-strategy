...
const Strategy = artifacts.require("ConvexStrategyGUSDMainnet");

//This test was developed at blockNumber 12555215

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex GUSD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xc8afC76a701D1304592ABc5a2e278e65Fd3d1Cde";
  let booster;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xB8671E33fcFC7FEA2F7a3Ea4a117F065ec4b009E",
