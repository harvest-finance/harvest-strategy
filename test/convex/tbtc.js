...
const Strategy = artifacts.require("ConvexStrategyTBTCMainnet");

//This test was developed at blockNumber 12555215

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex TBTC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x26fCbD3AFEbbE28D0A8684F790C48368D21665b5";
  let booster;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x640704D106E79e105FDA424f05467F005418F1B5",
