...
const Strategy = artifacts.require("ConvexStrategyAaveMainnet");

//This test was developed at blockNumber 12555215

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex Aave", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xa019A71F73922f5170031F99EFC37f31d3020f0b";
  let booster;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xc3EF8C4043D7cf1D15B6bb4cd307C844E0BA9d42",
