...
const OneInchStrategy_DAI_LDO = artifacts.require("OneInchStrategy_DAI_LDO");
...
describe("Mainnet DAI/LDO", function() {
  ...
  // external setup
  let underlyingWhale = "0x37e46caEfEF61D30E680cf754998B4A39e5d8325";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "strategyArtifact": OneInchStrategy_DAI_LDO,
