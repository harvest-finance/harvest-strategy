...
const Strategy = artifacts.require("SushiBuybackStrategyMainnet_PERP_WETH");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Sushiswap PERP-WETH buyback test", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x8486c538dcbd6a707c5b3f730b6413286fe8c854");
