...
const Strategy = artifacts.require("BasisGold2FarmStrategyMainnet_DAI_BSG");
const NoMintRewardPool = artifacts.require("NoMintRewardPool");
const RewardDistributionSwitcher = artifacts.require("RewardDistributionSwitcher");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Basis Gold to FARM: DAI_BSG ", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xef35dfbd99e100776f76976948e250cd0a89c7ef";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x4A9596E5d2f9bEF50E4De092AD7181aE3C40353e");
