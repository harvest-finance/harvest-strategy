...
const Strategy = artifacts.require("BasisGold2FarmStrategyMainnet_DAI_BSGS");
const NoMintRewardPool = artifacts.require("NoMintRewardPool");
const RewardDistributionSwitcher = artifacts.require("RewardDistributionSwitcher");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Basis Gold to FARM: DAI_BSGS ", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x8f58C7668Bc1BD09D597B65C2d8525A593708280";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x980a07E4F64d21a0cB2eF8D4AF362a79b9f5c0DA");
