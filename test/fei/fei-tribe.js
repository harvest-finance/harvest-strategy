...
const Strategy = artifacts.require("FeiStrategyMainnet_FEI_TRIBE");

//Test was developed at blockNumber 12181440

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Fei Protocol FEI/TRIBE", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [{"uni": [tribe, weth, farm]}],
    });
