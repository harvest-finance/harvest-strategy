...
const Strategy = artifacts.require("Basis2FarmStrategyMainnet_DAI_BAS");
const RewardDistributionSwitcher = artifacts.require("RewardDistributionSwitcher");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Basis DAI_BAS", function() {
  let accounts;
  ...
  let underlyingWhale = "0x08bb933f6560d28c23e14523b93c8544ad6a92fd";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x0379dA7a5895D13037B6937b109fA8607a659ADF");
