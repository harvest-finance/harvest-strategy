...
const Strategy = artifacts.require("FoxStrategyMainnet_FOX_ETH");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("ShapeShift FOX-WETH", function() {
  let accounts;
  ...
  // external setup
  // block: 12863375
  let underlyingWhale = "0x66E595cB7589213dd30C218230592a7D6c514fBd";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x470e8de2eBaef52014A47Cb5E6aF86884947F08c");
  ...
  before(async function() {
    ...
    [controller, vault, strategy, rewardPool] = await setupCoreProtocol({
      ...
      "liquidation": [{
        // fox -> weth -> farm
        "uni": ["0xc770EEfAd204B5180dF6a14Ee197D99d808ee52d",
