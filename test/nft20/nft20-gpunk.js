...
const IRewardPool = artifacts.require("IRewardPool");

//const Strategy = artifacts.require("");
const Strategy = artifacts.require("NFT20Strategy_GPUNK");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("NFT20 GPUNK-ETH", function() {
  let accounts;
  ...
  // external setup
  // block: 12196100
  let underlyingWhale = "0x22e0e866588cb82a3fbaed83893d987bdbdfb085";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xBb1565072FB4f3244eBcE5Bc8Dfeda6baEb78Ad3");
