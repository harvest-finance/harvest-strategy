...
const Strategy = artifacts.require("NFT20Strategy_MASK");
const IMasterChef = artifacts.require("IMasterChef");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("NFT2 MASK-ETH", function() {
  let accounts;
  ...
  // external setup
  // block: 12043941
  let underlyingWhale = "0xa6584b95ea4e9018b1f377dad99448ec478a150f"; // unstake
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xaa617C8726ADFDe9e7b08746457E6b90ddB21480");
  ...
  async function setupBalance(){
    ...
    let masterchef = await IMasterChef.at("0x193b775aF4BF9E11656cA48724A710359446BF52");
    await masterchef.withdraw(5, "39" + "000000000000000000", { from: underlyingWhale });
