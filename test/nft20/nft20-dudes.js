...
const Strategy = artifacts.require("NFT20Strategy_DUDES");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("NFT2 DUDES20-ETH", function() {
  let accounts;
  ...
  // external setup
  // block: 12043941
  let underlyingWhale = "0x79bf225fbfd40f78b1878a6d1eec1bb03df92aeb"; // unstake
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x04914cb01eeC94E320e3A88b3c7A7e9B1609d13C");
