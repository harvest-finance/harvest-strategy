...
contract MirrorV2Mainnet_mGOOGL_UST is SNXRewardStrategyWithBuyback {

  address public mgoogl_ust = address(0x4b70ccD1Cf9905BE1FaEd025EADbD3Ab124efe9a);
  ...
  address public mgoogl = address(0x59A921Db27Dd6d4d974745B7FfC5c33932653442);
  ...
  SNXRewardStrategyWithBuyback(_storage, mgoogl_ust, _vault, rewardPool, mir, uniswapRouterAddress, _distributionPool, 5000)
  public {
    require(IVault(_vault).underlying() == mgoogl_ust, "Underlying mismatch");
    uniswapRoutes[mgoogl] = [mir, ust, mgoogl];
