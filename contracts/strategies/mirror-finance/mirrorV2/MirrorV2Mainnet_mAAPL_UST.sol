...
contract MirrorV2Mainnet_mAAPL_UST is SNXRewardStrategyWithBuyback {
  ...
  address public maapl_ust = address(0xB022e08aDc8bA2dE6bA4fECb59C6D502f66e953B);
  ...
  address public maapl = address(0xd36932143F6eBDEDD872D5Fb0651f4B72Fd15a84);
  ...
  SNXRewardStrategyWithBuyback(_storage, maapl_ust, _vault, rewardPool, mir, uniswapRouterAddress, _distributionPool, 5000)
  public {
    require(IVault(_vault).underlying() == maapl_ust, "Underlying mismatch");
    uniswapRoutes[maapl] = [mir, ust, maapl];
