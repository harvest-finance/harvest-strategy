...
*/
contract OneInchStrategy_ONEINCH_X is StrategyBase {
  ...
  address[] public uniswap_ONEINCH2Token1;
  ...
  StrategyBase(_storage, _underlying, _vault, oneInch, address(0)) public {
    ...
    uniswap_ONEINCH2Token1 = [oneInch, token1];
  ...
  */
  ...
  function claimAndLiquidate() internal {
    ...
    IFarmingRewards(pool).getAllRewards();
