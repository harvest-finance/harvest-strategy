...
contract VaultWeth is ERC20, ERC20Detailed, IUpgradeSource, ControllableInit, VaultStorage {
  ...
  function initializeVault(address _storage,
    ...
    require(_underlying == 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2, "underlying has to be WETH");
  ...
  * Approval is assumed.
  */
  function deposit(uint256 amount) external defense payable {
